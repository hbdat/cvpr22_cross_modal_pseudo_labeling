...
def do_openimages_coco_evaluation(
    dataset,
    predictions,
    box_only,
    output_folder,
...
def prepare_for_coco_detection(predictions, dataset):
    ...
    for image_id, prediction in enumerate(predictions):
        ...
        if dataset.imagelevel:
            ...
            valid_inds = np.nonzero(np.isin(labels.cpu().numpy(), labeled_classes))[0].tolist()
