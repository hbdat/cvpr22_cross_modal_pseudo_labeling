...
class UnbiasedTeacherBaseline(nn.Module):
    """
    ...
    def __init__(self, cfg):
        super(UnbiasedTeacherBaseline, self).__init__()
    ...
    def forward(self, images, targets=None):
        ...
        if self.training:
            ...
            if len(idxs_cap) > 0:
                ...
                try:
                    _,_, loss_pseudo = self.roi_heads_student(cap_features, cap_proposals, pseudo_targets, is_pseudo=True)
