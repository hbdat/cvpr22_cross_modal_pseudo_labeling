...
class BA_RPNBaseline(nn.Module):
    """
    ...
    def __init__(self, cfg):
        super(BA_RPNBaseline, self).__init__()

        self.backbone = build_backbone(cfg)
        self.rpn = build_rpn(cfg, self.backbone.out_channels)
        background_classifier = self.rpn.head.cls_logits
        self.roi_heads = build_roi_heads(cfg, self.backbone.out_channels,background_classifier)
