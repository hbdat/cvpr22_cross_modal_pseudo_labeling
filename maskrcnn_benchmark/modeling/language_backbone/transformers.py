...
class BERT(nn.Module):
    def __init__(self, config):
        ...
        self.embeddings = nn.Parameter(self.bert_model.embeddings.word_embeddings.weight, requires_grad = self.config.MODEL.LANGUAGE_BACKBONE.FT_EMB)
